...
export {default as handleCreateActivity} from './Activities/handleCreateActivity'; 

/* --- ROUTINE ACTIVITY --- */
export {default as handleCreateRoutineActivity} from './RoutineActivities/handleCreateRoutineActivity'; 
